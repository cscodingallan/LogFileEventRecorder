...
public class JacksonJsonArraySimpleObjectStreamerTest {
    ...
    public void testSingleLogEvent() throws IOException {
        ...
        InputStream jsonInputStream = logEventInputStreamFactory.createLogEventInputStream(logEvent);
    ...
    public void testMultipleLogEvents() throws IOException {
        ...
        LogEvent [] logEvents = { logEvent1, logEvent2, logEvent3 };

        InputStream jsonInputStream = logEventInputStreamFactory.createLogEventInputStream(logEvents);
